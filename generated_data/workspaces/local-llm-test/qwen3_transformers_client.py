"""Client for qwen3_transformers_server.py.

Examples:
    python qwen3_transformers_client.py --prompt "Hello"
    python qwen3_transformers_client.py --server http://192.168.1.84:5003 --prompt "Hello"
    python qwen3_transformers_client.py --server http://192.168.1.84:5003 --health
...
DEFAULT_SERVER_URL = os.environ.get("QWEN3_TRANSFORMERS_SERVER_URL", "http://127.0.0.1:5003")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Client for qwen3_transformers_server.py")
    parser.add_argument(
        "--server",
        default=DEFAULT_SERVER_URL,
        help="Base URL or /chat URL for qwen3_transformers_server.py",
    )
