...
class OpenAIFunctionCallingPlugin:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "call FileReaderPlugin.read_image_gps first to get EXIF/metadata, then call FileReaderPlugin.read_image_for_vision "
            "(or use pixels already in context) for the visual description. "
